...
export default function PrintShopInfo() {
  return (
    <div className="space-y-6">
      {/* Monetization Plans */}
      <section>
        <h2 className="font-heading text-xl font-extrabold text-[#2D2D2D] hidden">Monetization Plans</h2>
      ...
      {/* Free — Rolling 10 */}
      <section className="rounded-2xl border border-[#E8E2D8] bg-[#e7f5ff] p-5 hidden">
      ...
      {/* Premium */}
      <section className="rounded-2xl border border-[#E8E2D8] bg-[#fff0f6] p-5 hidden">
        <div className="flex items-center gap-2">
      ...
      {/* Print Club */}
      <section className="rounded-2xl border border-[#E8E2D8] bg-white p-5 hidden">
        <div className="flex items-center gap-2">
