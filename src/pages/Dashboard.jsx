...
export default function Dashboard() {
  ...
  return <div className="space-y-7"><section><div className="mt-1 flex items-center gap-3"><h1 className="font-heading text-3xl font-extrabold">Vendi's booth</h1><span className="rounded-full bg-[#EEF2FF] px-3 py-1 text-xs font-bold capitalize text-[#4F46E5]">{plan}</span></div></section>
